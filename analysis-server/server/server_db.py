...
class EventImagePaths(models.Model):
    event = models.ForeignKey(Event, models.DO_NOTHING)
    image_paths = models.CharField(max_length=255)

    class Meta:
        managed = False
        db_table = 'event_image_paths'
...
class StoreImagePaths(models.Model):
    store = models.ForeignKey(Store, models.DO_NOTHING)
    image_paths = models.CharField(max_length=255, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'store_image_paths'


class TaskJoinPost(models.Model):
    id = models.BigAutoField(primary_key=True)
    join_post = models.ForeignKey(JoinPost, models.DO_NOTHING)
