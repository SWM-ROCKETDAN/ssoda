...
public enum ErrorCode {
    ...
    // 이벤트 참여
    JOIN_EVENT_FAILED(403, "JOIN_EVENT001", "JOIN_EVENT_FAILED."),
    JOIN_DIFFERENT_EVENT(403, "JOIN_EVENT002", "JOIN_DIFFERENT_EVENT."), // 이전에 참여한 이벤트와 다른 이벤트
    JOIN_INVALID_EVENT(403, "JOIN_EVENT003", "JOIN_INVALID_EVENT."), // 유효하지 않은 이벤트에 참여(진행중이 아닌)
    // Analysis server
