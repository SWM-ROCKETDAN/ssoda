...
public class HashtagEventUpdateRequest extends EventUpdateRequestDto {
    ...
    @Builder
    public HashtagEventUpdateRequest(String title, Integer status, @DateTimeFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss") Date startDate, @DateTimeFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss") Date finishDate, List<String> images, List<Reward> rewards,
